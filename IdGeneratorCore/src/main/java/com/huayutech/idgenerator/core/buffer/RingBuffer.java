...
public class RingBuffer {
     ...
     * If there is no more available UID to be taken, the specified {@link RuntimeException} will be applied<br>
     * 
     * @return UID
    ...
    public long take() {
        ...
        if (nextCursor == currentCursor) {
            throw new RuntimeException("Rejected take buffer. " + this);
        }
     ...
     * Setters
     */
    public void setBufferPaddingExecutor(RingBufferPaddingExecutor bufferPaddingExecutor) {
